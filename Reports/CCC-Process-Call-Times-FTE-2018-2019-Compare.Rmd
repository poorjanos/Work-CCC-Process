...
t_call_times %>%
  ...
  labs(
    x = "Call Type",
    y = "Rate of Change (%)",
    title = "KPIs: Change from 2018 to 2019 (Jan-May)"
  )
```
...
t_call_times %>%
  ...
  ggplot(aes(x = ACTIVITY_EN, y = FTE)) +
    ...
    labs(
      x = "Call types",
    y = "FTE",
    title = "Call Types FTE Comparison"
    )
```

### 3.1.2. Call Types FTE Change 2018-2019
...
t_call_times %>%
  ...
  ggplot(aes(x = ACTIVITY_EN, y = FTE)) +
    ...
    labs(
      x = "Call types",
    y = "FTE Change Rate (%)",
    title = "Call Types FTE Change 2018-2019"
    )
```
...
t_call_times %>%
  ...
  ggplot(aes(x = SEGMENT, y = WRAPUP)) +
    ...
    labs(
      x = "Request Type (in decreasing order of absolute wrap-up ratio)",
    y = "Rate of Change (%)",
