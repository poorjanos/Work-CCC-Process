/* Formatted on 2019. 06. 21. 10:25:32 (QP5 v5.115.810.9015) */
...
DROP TABLE t_call_times_2019_cor;
COMMIT;

CREATE TABLE t_call_times_2019_cor
AS
     SELECT   DISTINCT
              f_paid AS case_id,
